...
module.exports = (roles) => {
    return (req, res, next) => {
        ...
        if (roles.include(userRole)) { // kodaciklama: eğer roles(teacher,admin), girilen rollere(userRole) denk ise devam et. Değil ise yani student ise yetki verilmez yani else ile devam eder.
            next()
        } else {
